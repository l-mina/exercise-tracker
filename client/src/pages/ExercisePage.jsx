...
function ExercisePage(){
    const { loading, error, fetchExercise, deleteExercise, exerciseData, setAddFormData, currentExercise, updateExercise } = exerciseStore();
    ...
    return (
        <div className="min-h-screen bg-base-300 m-2 p-2 md:m-4 p-4 flex-col">
                        ...
                        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); updateExercise(id); }}>
                            ...
                            <div className="form-control">
                                ...
                                <input 
                                    ...
                                    onKeyDown={(e) => {
                                        const input = exerciseData.tagInput.trim();
